...
# for llama-7b
python main.py -task_name $1 -cuda 0 -load_check_point False -model_name $2 -checkpoint_path $3 -wandb none -mode evaluate -pos True -data_spliting end2end -mode end2end -use_bad_words_ids False -ncontext 10 -gcontext 10 -length_penalty 1.0 -output test
# for gpt2-xl
...
# python main.py -task_name Huth_1 -cuda 0 -load_check_point False -model_name gptt2-xl -checkpoint_path Huth_1_gpt2-xl_pre0 -wandb none -mode evaluate -pos True -data_spliting end2end -mode end2end -use_bad_words_ids False -ncontext 10 -gcontext 10 -length_penalty 0.3 -output test.n10.g10.l0.3 -num_steps 100 
# for huth
