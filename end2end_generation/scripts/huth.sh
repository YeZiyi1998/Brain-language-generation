...
python main.py -task_name Huth_1 -cuda 0 -load_check_point False -model_name huth -checkpoint_path Huth_1_huth -pretrain_lr 1e-3 -pretrain_epochs 10 -wandb none -mode evaluate -pos True -data_spliting end2end -mode end2end -use_bad_words_ids True 

python main.py -task_name Huth_1 -cuda 0 -load_check_point False -model_name gpt2-xl -checkpoint_path Huth_1_gpt2-xl -pretrain_lr 1e-3 -pretrain_epochs 10 -wandb none -mode evaluate -pos True -data_spliting end2end -mode end2end -use_bad_words_ids True 
