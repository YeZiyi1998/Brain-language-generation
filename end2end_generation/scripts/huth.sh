...
# python main.py -task_name Huth_2 -cuda 0 -load_check_point False -model_name llama-7b -checkpoint_path Huth_2_llama-7b_pre0 -wandb none -mode evaluate -pos True -data_spliting end2end -mode end2end -use_bad_words_ids False -ncontext 10 -gcontext 10 -length_penalty 1.0 -output test
# for gpt2-xl
