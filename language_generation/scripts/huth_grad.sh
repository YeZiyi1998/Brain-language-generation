...
# python main.py -task_name Huth_1 -cuda 0 -load_check_point False -model_name huth -checkpoint_path Huth_1_huth -batch_size 8 -lr 1e-4 -pretrain_lr 1e-3 -pretrain_epochs 0 -wandb none -mode all -pos True -data_spliting end2end -early_stop 3 -loss all
# python main.py -task_name $1 -cuda 0 -load_check_point False -model_name $2 -checkpoint_path $3 -batch_size 8 -lr 1e-4 -pretrain_lr 1e-3 -pretrain_epochs 0 -wandb none -mode all -pos True -data_spliting end2end -early_stop 3 -loss all -enable_grad True